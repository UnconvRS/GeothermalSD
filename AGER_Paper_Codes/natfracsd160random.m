function [description, options, state0, model, schedule, plotOptions] = natfracsd160random(varargin)
...
min_frac_length=0.007;

set1=Field(DFN('dim',2,'n',NumNaturalFracs,'bbx',Domain,'dir',45,'ddir',-1e-9,...
