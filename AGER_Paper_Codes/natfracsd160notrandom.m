function [description, options, state0, model, schedule, plotOptions] = natfracsd160notrandom(varargin)
...
min_frac_length=0.003;

set1=Field(DFN('dim',2,'n',NumNaturalFracs,'bbx',Domain,'dir',45,'ddir',-1e9,...
    'minl',min_frac_length,'mu',avg_frac_length,'maxl',max_frac_length),'Line');
