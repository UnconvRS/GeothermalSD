function [description, options, state0, model, schedule, plotOptions] = initialsd3spotlbfixedbt(varargin)
...
% intInx = any(N == 0, 2);
% bcells  = [N(intInx, 2);N(intInx, 1)];
% bcells=bcells(bcells~=0);
% rock.CpR(bcells)=rock.CpR(bcells)*1e10;
% Make fluid
