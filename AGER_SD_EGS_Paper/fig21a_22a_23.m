function [description, options, state0, model, schedule, plotOptions] = fig21a_22a_23(varargin)
...
for i=1:length(G.cells.NF)
    %Section 1
    if G.cells.centroids(i,1)<200 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<200 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<200 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
        if G.cells.centroids(i,3)<150 || G.cells.centroids(i,3)>175
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<200 && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end
    % Section 2
    if G.cells.centroids(i,1)<400 && G.cells.centroids(i,1)>200 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<400 && G.cells.centroids(i,1)>200 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<400 && G.cells.centroids(i,1)>200 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
         if G.cells.centroids(i,3)<150 || G.cells.centroids(i,3)>175
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<400 && G.cells.centroids(i,1)>200  && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end  
     ...
     % Section 3
    if G.cells.centroids(i,1)<600 && G.cells.centroids(i,1)>400 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<600 && G.cells.centroids(i,1)>400 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<600 && G.cells.centroids(i,1)>400 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
         if G.cells.centroids(i,3)<150 || G.cells.centroids(i,3)>175
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<600 && G.cells.centroids(i,1)>400 && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end  
         ...
         % Section 4
    if G.cells.centroids(i,1)<800 && G.cells.centroids(i,1)>600 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<800 && G.cells.centroids(i,1)>600 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<800 && G.cells.centroids(i,1)>600 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
        if G.cells.centroids(i,3)<150 || G.cells.centroids(i,3)>175
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<800 && G.cells.centroids(i,1)>600 && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end  
          ...
          % Section 5
    if G.cells.centroids(i,1)<1000 && G.cells.centroids(i,1)>800 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1000 && G.cells.centroids(i,1)>800 && G.cells.centroids(i,1)>800 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1000 && G.cells.centroids(i,1)>800 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
        if G.cells.centroids(i,3)<150 || G.cells.centroids(i,3)>175
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1000 && G.cells.centroids(i,1)>800 && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end 
    ...
    % Section 6
    if G.cells.centroids(i,1)<1200 && G.cells.centroids(i,1)>1000 && G.cells.centroids(i,2)<150
        if G.cells.centroids(i,3)<10 || G.cells.centroids(i,3)>70
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1200 && G.cells.centroids(i,1)>1000 && G.cells.centroids(i,2)>150 && G.cells.centroids(i,2)<300
        if G.cells.centroids(i,3)<70 || G.cells.centroids(i,3)>150
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1200 && G.cells.centroids(i,1)>1000 && G.cells.centroids(i,2)>300 && G.cells.centroids(i,2)<450
        if G.cells.centroids(i,3)<300 || G.cells.centroids(i,3)>350
            G.cells.NF(i)=0;
        end
    end
    if G.cells.centroids(i,1)<1200 && G.cells.centroids(i,1)>1000 && G.cells.centroids(i,2)>450 && G.cells.centroids(i,2)<600 
        if G.cells.centroids(i,3)<175 || G.cells.centroids(i,3)>240
            G.cells.NF(i)=0;
        end
    end
